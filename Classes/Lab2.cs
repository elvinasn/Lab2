...
namespace Lab2
{
    ...
    {
        protected static void FillTableWithPoints(PointsLinkedList points, ref Table Table1)
        {
        ...
        protected static void FillTableWithTriangles(TrianglesLinkedList triangles, ref Table Table1)
        {
            TableRow row = new TableRow();
            TableCell cell1 = new TableCell();
            TableCell cell2 = new TableCell();
